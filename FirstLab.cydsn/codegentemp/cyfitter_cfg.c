...
#define BS_IOPINS0_8_VAL ((const uint8 CYFAR *)0x48000530u)
...
#define BS_IOPINS0_3_VAL ((const uint8 CYFAR *)0x48000550u)

/* CYDEV_CLKDIST_ACFG0_CFG0 Address: CYREG_CLKDIST_ACFG0_CFG0 Size (bytes): 4 */
#define BS_CYDEV_CLKDIST_ACFG0_CFG0_VAL ((const uint8 CYFAR *)0x4800055Cu)
