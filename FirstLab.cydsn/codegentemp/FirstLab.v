// ======================================================================
// FirstLab.v generated from TopDesign.cysch
// 05/08/2020 at 11:07
...
// CharLCD_v2_20(ConversionRoutines=true, CUSTOM0="0,E,8,8,8,E,0,0,", CUSTOM1="0,A,A,4,4,4,0,0,", CUSTOM2="0,E,A,E,8,8,0,0,", CUSTOM3="0,E,A,C,A,A,0,0,", CUSTOM4="0,E,8,C,8,E,0,0,", CUSTOM5="0,E,8,E,2,E,0,0,", CUSTOM6="0,E,8,E,2,E,0,0,", CUSTOM7="0,4,4,4,0,4,0,0,", CustomCharacterSet=0, TypeReplacementString=uint8, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=CharLCD_v2_20, CY_CONFIG_TITLE=LCD_Screen, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=LCD_Screen, CY_INSTANCE_SHORT_NAME=LCD_Screen, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=20, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.3, INSTANCE_NAME=LCD_Screen, )
module CharLCD_v2_20_0 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("f3eec515-c829-424f-840e-ad9191266467/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module ADC_DelSig_v3_30_1 (
	...
	cy_clock_v1_0
		#(.id("f2e3cc93-74b2-41f0-be16-1b0fefd76468/b7604721-db56-4477-98c2-8fae77869066"),
	...
	cy_clock_v1_0
		#(.id("f2e3cc93-74b2-41f0-be16-1b0fefd76468/edd15f43-b66b-457b-be3a-5342345270c8"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
...
// VDAC8_v1_90(Data_Source=0, Initial_Value=100, Strobe_Mode=0, VDAC_Range=0, VDAC_Speed=0, Voltage=400, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=VDAC8_v1_90, CY_CONFIG_TITLE=VDAC, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=VDAC, CY_INSTANCE_SHORT_NAME=VDAC, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.3, INSTANCE_NAME=VDAC, )
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("ed3da779-f8c7-486f-9ec7-b1141d8ccfd0"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Pin_D3_net;
	wire [0:0] tmpFB_0__Pin_D3_net;
	wire [0:0] tmpIO_0__Pin_D3_net;
	wire [0:0] tmpINTERRUPT_0__Pin_D3_net;
	electrical [0:0] tmpSIOVREF__Pin_D3_net;

	cy_psoc3_pins_v1_10
		#(.id("ca112018-e815-4aaa-b5dc-322fac9ed196"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_D3
		 (.oe(tmpOE__Pin_D3_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_D3_net[0:0]}),
		  .io({tmpIO_0__Pin_D3_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_D3_net),
		  .interrupt({tmpINTERRUPT_0__Pin_D3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_D3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_D4_net;
	wire [0:0] tmpFB_0__Pin_D4_net;
	wire [0:0] tmpIO_0__Pin_D4_net;
	wire [0:0] tmpINTERRUPT_0__Pin_D4_net;
	electrical [0:0] tmpSIOVREF__Pin_D4_net;

	cy_psoc3_pins_v1_10
		#(.id("b928a68f-850f-4592-aa77-45a669b296b3"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_D4
		 (.oe(tmpOE__Pin_D4_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_D4_net[0:0]}),
		  .io({tmpIO_0__Pin_D4_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_D4_net),
		  .interrupt({tmpINTERRUPT_0__Pin_D4_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_D4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("5f01bdd6-a6bd-4d34-8e58-45c876594199"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Pin_SW3_net;
	wire [0:0] tmpFB_0__Pin_SW3_net;
	wire [0:0] tmpIO_0__Pin_SW3_net;
	wire [0:0] tmpINTERRUPT_0__Pin_SW3_net;
	electrical [0:0] tmpSIOVREF__Pin_SW3_net;

	cy_psoc3_pins_v1_10
		#(.id("284cd33d-7331-467a-87b0-740e09500e4a"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_SW3
		 (.oe(tmpOE__Pin_SW3_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_SW3_net[0:0]}),
	...
	assign tmpOE__Pin_SW3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_SW4_net;
	wire [0:0] tmpFB_0__Pin_SW4_net;
	wire [0:0] tmpIO_0__Pin_SW4_net;
	wire [0:0] tmpINTERRUPT_0__Pin_SW4_net;
	electrical [0:0] tmpSIOVREF__Pin_SW4_net;

	cy_psoc3_pins_v1_10
		#(.id("be151297-3b05-42b1-86c0-265e695dd067"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_SW4
		 (.oe(tmpOE__Pin_SW4_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_SW4_net[0:0]}),
		  .io({tmpIO_0__Pin_SW4_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_SW4_net),
		  .interrupt({tmpINTERRUPT_0__Pin_SW4_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_SW4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    CharLCD_v2_20_0 LCD_Screen ();
	...
	cy_psoc3_pins_v1_10
		#(.id("84ecf6e1-7314-4948-951d-e1f90b39350b"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("c8c47fc0-57d6-436c-94d5-be81042c68bd"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("fecd2f0e-b517-4ab3-afd7-0fa96d839ffb"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("37fceea3-4da8-465f-b6b8-6a5921587899"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("f78168ec-6604-431f-ad17-4bced3ad9e26"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("d4f2eead-85a7-4df6-9b59-80a3166bf025"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("45326f55-fa23-46e0-a227-fc5956fef443"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("c8607a40-2b05-4b85-956b-b66502a66912"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Pin_photoresistor_net;
	wire [0:0] tmpFB_0__Pin_photoresistor_net;
	wire [0:0] tmpIO_0__Pin_photoresistor_net;
	wire [0:0] tmpINTERRUPT_0__Pin_photoresistor_net;
	electrical [0:0] tmpSIOVREF__Pin_photoresistor_net;

	cy_psoc3_pins_v1_10
		#(.id("091969cb-a378-431d-a99b-6760de5714ec"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_photoresistor
		 (.oe(tmpOE__Pin_photoresistor_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_photoresistor_net[0:0]}),
		  .analog({Net_43}),
		  .io({tmpIO_0__Pin_photoresistor_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_photoresistor_net),
		  .interrupt({tmpINTERRUPT_0__Pin_photoresistor_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_photoresistor_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("fcd7506c-99fa-4082-bdb2-8f82860a2def"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    UART_v2_50_4 UART (
        ...
        .reset(1'b0),
        .rx(Net_124),
        .tx_interrupt(Net_125),
        .rx_interrupt(Net_126),
        .tx_data(Net_127),
        .tx_clk(Net_128),
        .rx_data(Net_129),
        .rx_clk(Net_130));
	...
	cy_psoc3_pins_v1_10
		#(.id("bd2e75d3-80a6-456e-94a5-e91e7966f245"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("68fd8e65-5ded-4322-8f04-eed3293cc195"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1000000000"),
		  .is_direct(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("43fa3149-1930-4226-bcf5-9054c0d14c91"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("970653cf-868f-43cb-8789-db84bba36bef"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1000000000"),
		  .is_direct(0),
